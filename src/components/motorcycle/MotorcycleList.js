...
const MotorcycleList = (props) => {
  const { motorcycles, handleDialog } = props;
              ...
              <tr key={motor.id} className="bg-white border-b hover:bg-gray-50">
                <td className="w-4 p-4">
                  <div className="flex items-center">
                    <span>{motor.model_no}</span>
                  </div>
                </td>
                <th scope="row" className="flex items-center px-6 py-4 text-gray-900 whitespace-nowrap">
                  <img className="w-10 h-10 rounded-full" src={motor.image_url} alt={motor.name} />
                  <div className="pl-3">
                    <div className="text-base font-semibold">{motor.name}</div>
                  </div>
                </th>
                <td className="px-6 py-4">
                  {motor.production_date}
                </td>
                <td className="px-6 py-4">

  ...
  /* List of Latest Models */
    <div className="flex flex-col w-full h-full bg-bg_secondary p-4 lg:p-6 overflow-x-hidden">
      ...
      <div className="flex flex-col w-full h-full justify-center items-center p-2">
          ...
          {motorcycles && motorcycles.map((motor) => (
            <SwiperSlide
              ...
              onClick={console.log('Slidddder clicked')}>
                {/* <span className="bg-gray-400 flex flex-col w-[10rem] h-[10rem] justify-center items-center rounded-full"></span>
                <div className="flex justify-center items-center">
                  <img src={vespa} className="fixed -top-2 rounded-full h-[11rem] w-[11rem] object-fill" alt="slide_image" />
                </div> */}
        ...
        <div className="swiper-pagination relative flex w-full justify-center items-center"></div>
      </div>
    </div>
  );
};

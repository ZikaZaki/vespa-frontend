...
const City = () => {
  ...
  <div className="flex flex-col w-full px-4 pt-6 pb-4 lg:px-6 lg:py-2 h-full">
    <div className="flex justify-between items-center w-full py-6">
      ...
      <button className="inline-flex items-center p-2 bg-blue-600 text-white font-medium text-sm rounded-md border-2 hover:bg-bg_secondary hover:text-blue-600 hover:border-blue-600 focus:outline-none focus:bg-white focus:border-blue-600 focus:text-blue-600">
        <svg
          viewBox="0 0 20 20"
          fill="currentColor"
          className="w-5 h-5"
